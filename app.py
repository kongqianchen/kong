...
test = {'grammar': {'grammarCumScore': 2.8947368421052633, 'grammarSentScore': {
    ...
    'Dog\n\nThe domestic dog (Canis lupus familiaris), is a subspecies of the gray wolf (Canis lupus), a member of the Canidae family of the mammilian order "Carnivora".': 1,
    ...
    'Remains of domesticated dogs have been found in Siberia and Belgium from about 33,000 years ago.': 1}},
        'statistics': {'stdDevSentLen': 12.731403797668182, 'wordCount': 432, 'paraCount': 5, 'sentCount': 19,
                       'avgSentLen': 22.736842105263158}, 'spellings': {'Spellings': 5, 'misspeltWordSug': {
        ...
        'familiaris': ['familiars', 'familiar is', 'familiar-is', 'familiarizes', 'familiarize', 'familiarity',
                       'familiarness', 'familiarizing', 'malarious']}},
