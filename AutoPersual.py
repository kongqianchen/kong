...
def mark_score(check_result):
    ...
    check_result['coherence']['relevantScore'] = check_result['coherence']['relevantScore'] * 100 / 5
    ...
    check_result['totalScore'] = (check_result['grammar']['grammarCumScore'] + check_result['statistics'][
        'statisticsScore'] + check_result['statistics']['statisticsScore'] + check_result['coherence']['relevantScore'])/ 4
    return check_result
...
def check_essay(essay):
    ...
    #relevant
    Coherence = getCoherenceMeasure(essay)
    result['coherence'] = {
       'relevantScore': Coherence
    }
